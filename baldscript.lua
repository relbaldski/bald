...
function main()
    ...
    tbl.UIListLayout.Padding = UDim.new(0.01, 0)
    tbl.UIListLayout.Parent = tbl.Buttons
    ...
    tbl.UIStroke_4.Parent = tbl.Button1
    ...
    tbl.Title_1.Position = UDim2.new(0.5, 0, 0.5, 0)
    tbl.Title_1.BackgroundTransparency = 1
    tbl.Title_1.Parent = tbl.Button4

    tbl.UICorner_8.CornerRadius = UDim.new(0.08, 0)
    tbl.UICorner_8.Parent = tbl.Button4
    ...
    tbl.UIStroke_5.Parent = tbl.Button4
    ...
    tbl.Title_2.Position = UDim2.new(0.5, 0, 0.5, 0)
    tbl.Title_2.BackgroundTransparency = 1
    tbl.Title_2.Parent = tbl.Button3

    tbl.UICorner_9.CornerRadius = UDim.new(0.08, 0)
    tbl.UICorner_9.Parent = tbl.Button3
    ...
    tbl.UIStroke_6.Parent = tbl.Button3
    ...
    tbl.Title_3.Position = UDim2.new(0.5, 0, 0.5, 0)
    tbl.Title_3.BackgroundTransparency = 1
    tbl.Title_3.Parent = tbl.Button2

    tbl.UICorner_10.CornerRadius = UDim.new(0.08, 0)
    tbl.UICorner_10.Parent = tbl.Button2
    ...
    tbl.UIStroke_7.Parent = tbl.Button2

    tbl.UICorner_11.CornerRadius = UDim.new(0.1, 0)
    tbl.UICorner_11.Parent = tbl.Buttons
    ...
    tbl.ScriptBox.TextSize = 30
    tbl.ScriptBox.ClipsDescendants = true
    tbl.ScriptBox.Size = UDim2.new(1, 0, 1, 0)
    tbl.ScriptBox.TextColor3 = Color3.fromRGB(255, 255, 255)
    ...
    tbl.ScriptBox.Parent = tbl.ScrollingFrame

    tbl.Highlighter.Name = "Highlighter"
    tbl.Highlighter.Parent = tbl.ScriptBox
